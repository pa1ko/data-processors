...
class PeselTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.pesel_df = pd.DataFrame(
            [('44112607890', 2, datetime(1944, 11, 26), True),
             ('70102108696', 2, datetime(1970, 10, 21), True),
             ('01320107989', 1, datetime(2001, 12, 1), True),
             ('99851201182', 1, datetime(1899, 5, 12), True),
